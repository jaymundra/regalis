...
export const products = [
  { name: "Oxford", images: [black_shoe_1, black_shoe_2, black_shoe_3, black_shoe_4, black_shoe_5], price: "Rs 3200", discounted: "Rs 1600", category: 'men', description: "A classic Oxford shoe", inclusions: ["Handcrafted by Master Artisans","Goodyear Welt Construction","Free Shipping"], exclusions: [] },
  { name: "Men’s Chestnut Lace Up with ortho footbed and insole cushioning", images: [brown_shoe_1, brown_shoe_2, brown_shoe_3, brown_shoe_4, brown_shoe_5], price: "Rs 4200", discounted: "Rs 2100", category: 'men', description: "A stylish Derby shoe", inclusions: ["Goodyear Welt Construction","Free Shipping"], exclusions: [] },
  { name: "Monk Strap", images: [tan_shoe_1, tan_shoe_2, tan_shoe_3, tan_shoe_4], price: "Rs 4800", discounted: "Rs 2400", category: 'men', description: "A sophisticated Monk Strap shoe", inclusions: ["Handcrafted by Master Artisans","Goodyear Welt Construction","Free Shipping"], exclusions: [] },
  { name: "Loafers", images: [female_black_1, female_black_2, female_black_3, female_black_4], price: "Rs 3900", discounted: "Rs 1950", category: 'women', description: "A comfortable Loafer shoe", inclusions: ["Handcrafted by Master Artisans","Goodyear Welt Construction","Free Shipping"], exclusions: [] },
  { name: "Heels", images: [female_beige_1, female_beige_2,female_beige_3,female_beige_4,female_beige_5], price: "Rs 5200", discounted: "Rs 2600", category: 'women', description: "Elegant Heels for women", inclusions: ["Handcrafted by Master Artisans","Goodyear Welt Construction","Free Shipping"], exclusions: [] },
  { name: "Classic Boots", images: [female_tan_1, female_tan_2, female_tan_3], price: "Rs 5800", discounted: "Rs 2900", category: 'women', description: "Timeless Classic Boots", inclusions: ["Handcrafted by Master Artisans","Goodyear Welt Construction","Free Shipping"], exclusions: [] },
];
